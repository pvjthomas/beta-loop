# Dilution Prep Table — 2× Volume (Hand Protocol)
...
|---|---|---|---:|---|---:|---:|---:|---|---:|
| **TEM-1 working solution** | 1:1000 | 100 ng/µL TEM-1 stock | 5 µL | BLB | 4,995 µL | **5,000 µL at 0.1 ng/µL** | 40 µL | 4 ng TEM-1; 0.04 ng/µL | 125 wells |
...
| **Matched vehicle** | 1:20 | 100% DMSO | 10 µL | BLB | 190 µL | **200 µL at 5% DMSO** | 10 µL | 0.5% DMSO channel; 0.75% total DMSO | 20 wells |
| **No-enzyme control** | — | BLB | 600 µL | — | — | **600 µL** | 40 µL | No TEM-1 | 15 wells |
| **BLB-only control addition** | — | BLB | 100 µL | — | — | **100 µL** | 10 µL | Maintains 100 µL total volume | 10 wells |
