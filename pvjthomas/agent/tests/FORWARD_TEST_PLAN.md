...
**Agent:** `forward_agent` (`pvjthomas/agent/`)  
**Version label:** `forward-research-agent-v1`  
**Frozen snapshot:** [`data/runs/forward/v1/`](../../../data/runs/forward/v1/manifest.json)  
...
2. Store curated literature on the canonical ref: `data/literature/refs/{canonical_id}.json`.
...
3. Write a literature-only stub under `data/literature/refs/_literature_only/{normalized_name}.json` **or** hold in `state.json` until bridge_agent assigns a Tanimoto analog.
...
```
pvjthomas/agent/tests/fixtures/
...
- `forward.manifest`: `"data/runs/forward/v1/manifest.json"`
...
- [`../../../data/runs/README.md`](../../../data/runs/README.md) — forward v1 versioning
- [`../../../data/literature/refs/README.md`](../../../data/literature/refs/README.md) — ref JSON schema
