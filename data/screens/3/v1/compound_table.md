...
All eight compounds were on **Run 2 v5** at the concentrations below (T1262 @ 1 µM in both rounds). R2 post-run analysis: [`r2_round_summary_eda.json`](../../2/post-run/analysis/r2_round_summary_eda.json). Long endpoint = median **A490 at last kinetic read (~900 s)** over R2 replicate wells **not** flagged failed by enzyme QC.
